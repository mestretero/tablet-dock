...
- 🎵 **Medya & ses** — oynat/duraklat/ileri, ses, çalan şarkı, ve hoparlör/kulaklık değiştirme butonu.
...
**`backend/apps.json`**'u istediğin zaman düzenle (otomatik okunur — yeniden başlatma yok):
